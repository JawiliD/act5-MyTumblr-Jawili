        ...
        <div class="bg-white shadow rounded overflow-hidden">
            ...
            <div class="py-4 px-4">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 mb-2 pr-lg-1"><img src="images/photo-1.png" alt="" class="img-fluid rounded shadow-sm"></div>              
                    <div class="col-lg-6 mb-2 pl-lg-1"><img src="images/photo-2.png" alt="" class="img-fluid rounded shadow-sm"></div>                
                    <div class="col-lg-6 pr-lg-1 mb-2"><img src="images/photo-3.png" alt="" class="img-fluid rounded shadow-sm"></div>
                    <div class="col-lg-6 pl-lg-1"><img src="images/photo-4.png" alt="" class="img-fluid rounded shadow-sm"></div>
                </div> 
            </div>
